...
0x40000600f-0x400006000		& W	& bit50-32,18-0   & 論理UNIT\#0.0のea0o,ea0b(virt-addr)    \\
				&  	& bit114-96,82-64 & 論理UNIT\#0.0のea1o,ea1b(virt-addr)    \\
0x400006017-0x400006010		& W	& bit31-0    & 論理UNIT\#0.0のtop(virt-addr)    \\
				&  	& bit63-32   & 論理UNIT\#0.0のbot(virt-addr)    \\
0x40000602f-0x400006020		& W	& bit50-32,18-0   & 論理UNIT\#0.1のea0o,ea0b(virt-addr)    \\
				&  	& bit114-96,82-64 & 論理UNIT\#0.1のea1o,ea1b(virt-addr)    \\
0x400006037-0x400006030		& W	& bit31-0    & 論理UNIT\#0.1のtop(virt-addr)    \\
				&  	& bit63-32   & 論理UNIT\#0.1のbot(virt-addr)    \\
:				& :	&            & : \\
0x400007fef-0x400007fe0		& W	& bit50-32,18-0   & 論理UNIT\#63.3のea0o,ea0b(virt-addr)   \\
				&  	& bit114-96,82-64 & 論理UNIT\#63.3のea1o,ea1b(virt-addr)   \\
0x400007ff7-0x400007ff0		& W	& bit31-0    & 論理UNIT\#63.3のtop(virt-addr)   \\
				&  	& bit63-32   & 論理UNIT\#63.3のbot(virt-addr)   \\\hline
...
う．具体的には，旧lmmiと新lmmiを比較し，旧lmmiが書き込み先（lmw），または，
旧lmmiが強制LOAD+書き込み対象（lmx）の時，当該dirty-LMMを主記憶へ追い出すDMA
を起動しなければならない．また，新lmmiに対応する領域がLMMに存在しない場合，
または，強制LOAD対象（lmfまたはlmx）の場合，主記憶から当該LMMへのDMAを起動し
なければならない．IMAXがDMA動作中の場合，STATUS.LMRINGにBUSYが表示される．
...
力のように，アドレスが同じでも内容が異なる場合に使用する．ストアの場合，
dirty-LMMの場合は，まずホスト主記憶に追い出される．次に，バースト演算前にホ
スト主記憶からLMMに新しいデータを転送する．
\end{description}
...
\multicolumn{5}{l}{\hspace{.1in}Dirty-LMMを追い出し後,先頭アドレスが同じであっても主記憶からLMMへ初期値を転送             }\\
