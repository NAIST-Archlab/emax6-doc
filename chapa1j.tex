...
\item プログラム例（疎行列行列積）                                 \dotfill proj-arm64/sample/spgemm/test022.c
\item プログラム例（疎行列圧縮）                                   \dotfill proj-arm64/sample/spgemm/test024.c
...
\item◇Yasuhiko Nakashima:
  ...
  GX実現に向けた異分野連携シンポジウム, Osaka, Apr. (2024)
\item◇Yasuhiko Nakashima:
  "IMAX3: An Alternative Approach to Green PiM",
  Green and Low Carbon Computing Seminar, Yokohama, Apr. (2024)
\item◇Yasuhiko Nakashima:
  "IMAX3: An Alternative Approach to Green PiM",
  京都クオリアフォーラム, 島津製作所, Apr. (2024)
